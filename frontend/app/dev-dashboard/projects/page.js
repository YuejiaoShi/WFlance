...
import {
  ...
  MobileTableSkeleton,
} from "@/app/_components/DevDashboard/TableSkeletons";
import { getFieldFromCookie } from "@/app/utils/auth";
import {
  getAllProjects,
  getAllProjectsFromDeveloper,
} from "@/app/utils/projectUtil";
...
function ProjectsPage() {
  ...
  return (
    <div className="h-full mx-auto max-w-screen-xl flex-grow ">
      <Breadcrumbs
        breadcrumbs={[{ label: "Projects", href: "/dev-dashboard/projects" }]}
      />
